...
import { TrashIcon,ArrowUpRightIcon,DownloadIcon } from "lucide-react"
    ...
    {Array.from({ length: 6 }).map((_, i) => (
     ...
     {!loading && thumbnails.length === 0 && (
        <div className="text-center py-24">
            <h3 className="textlg font-semibold text-zinc-200">No thumbnails yet</h3>
...
>
  ...
  <DownloadIcon
    onClick={() => handleDelete(thumb.image_url!)}
    className="size-6 bg-black/50 p-1 rounded hover:bg-pink-600 transition-all"
  />
